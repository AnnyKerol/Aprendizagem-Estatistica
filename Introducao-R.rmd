...
Você pode baixar em [RStudio IDE](https://www.rstudio.com/products/rstudio/).
...
O R é uma linguagem interativa, ou seja, que permite ao usuário enviar um comando por vez e receber o resultado.
